  ...
  return (
    ...
    >
      ...
      >
        {/* Front (hidden face) */}
        <div
          className="card-face w-full h-full flex items-center justify-center rounded-xl border-2 border-slate-600 bg-gradient-to-br from-indigo-800 to-slate-800 shadow-lg"
        ...
        >
          {card.color ? (
            ...
            <span className={`${sizeClass.includes('text') ? '' : 'text-3xl'} leading-none`}>
              {card.value}
            </span>
          )}
        </div>
